...
export const CATALOG_PROMPTS: CatalogPrompt[] = [
  {
    ...
    model: 'onprem/gpt-oss-120b', uses30d: 4820, updatedAt: '2026-01-06',
  ...
  },
  {
    ...
    model: 'onprem/qwen3-32b', uses30d: 2140, updatedAt: '2026-01-05',
  ...
  },
  {
    ...
    model: 'onprem/llama-3.3-70b', uses30d: 960, updatedAt: '2026-01-04',
    meta: { scope: '계열사', rating: 4.3, ratingCount: 22, installs: 3, tags: ['여신', '심사', '초안'] },
  },
  {
    id: 'PRM-231', name: '고객 응대 톤 교정', tenant: 'BNK캐피탈', owner: '윤참여',
    description: '초안 응대문을 금융 표준 문체로 교정한다. 단정·확약 표현을 걸러낸다.',
    model: 'onprem/qwen3-32b', uses30d: 1380, updatedAt: '2026-01-03',
    meta: { scope: '그룹', rating: 4.1, ratingCount: 17, installs: 9, tags: ['응대', '문체', '대고객'] },
  },
  {
    id: 'PRM-309', name: '내부 보고서 개조식 변환', tenant: 'BNK투자증권', owner: '강개발',
    description: '서술형 문단을 개조식 보고 형식으로 바꾼다.', model: 'onprem/gpt-oss-120b',
    uses30d: 410, updatedAt: '2025-12-29',
...
export const CATALOG_MCP: CatalogMcp[] = [
  {
    ...
    readOnly: true, calls30d: 8420, updatedAt: '2026-01-08',
  ...
  },
  {
    ...
    readOnly: true, calls30d: 3110, updatedAt: '2026-01-08',
  ...
  },
  {
    ...
    readOnly: true, calls30d: 26400, updatedAt: '2026-01-07',
  ...
  },
  {
    ...
    readOnly: true, calls30d: 5180, updatedAt: '2026-01-06',
  ...
  },
  {
    ...
    readOnly: true, calls30d: 1920, updatedAt: '2026-01-02',
  ...
  },
  {
    ...
    readOnly: false, calls30d: 0, updatedAt: '2026-01-08',
...
export function getCatalogItems(): CatalogItem[] {
  const agents: CatalogItem[] = MOCK_CATALOG_AGENTS.map((a) => ({
    ...
    meta: AGENT_META[a.id] ?? { scope: '개인', rating: 0, ratingCount: 0, installs: 0, tags: [] },
  ...
  const prompts: CatalogItem[] = CATALOG_PROMPTS.map((p) => ({
    ...
    updatedAt: p.updatedAt, meta: p.meta, extra: p.model,
  }));
  const mcp: CatalogItem[] = CATALOG_MCP.map((m) => ({
    ...
    updatedAt: m.updatedAt, meta: m.meta,
