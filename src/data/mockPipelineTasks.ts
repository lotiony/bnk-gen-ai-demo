...
export const MOCK_PIPELINE_TASKS: PipelineTask[] = [
  {
    ...
    indexes: [
      {
        ...
        sens: 2,
        refresh: '분기',
        lastSync: '2026-06-01 14:08',
        pendingChunks: 0,
        pinnedVersion: 'v4',
        versions: [
          {
            version: 'v4',
            createdAt: '2026-01-18 09:34',
            createdBy: '윤지수',
            modelId: 'bge-m3-ko',
            kind: 'hybrid',
            vectors: 3415,
    ...
    apiKey: {
      ...
      issuedAt: '2026-05-29 10:24',
      issuedBy: '조현우',
      callCount: 4218,
      lastUsedAt: '2026-06-02 13:58',
    },
    devDeployments: [
      {
        id: 'dep-3',
        version: 'd3',
        deployedAt: '2026-06-01 14:08',
        deployedBy: '조현우',
        indexConfig: [
        ...
        approvalId: 'APV-2026-100',
      },
      {
        id: 'dep-2',
        version: 'd2',
        deployedAt: '2026-05-18 11:20',
        deployedBy: '윤지수',
        indexConfig: [
        ...
        approvalId: 'APV-2026-099',
      },
      {
        id: 'dep-1',
        version: 'd1',
        deployedAt: '2026-05-01 09:48',
        deployedBy: '조현우',
        indexConfig: [
          { indexId: 'idx-vp-call-7m2k', indexName: '보이스피싱_탐지_지식인덱스', version: 'v3' },
        ],
