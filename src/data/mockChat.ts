...
- 동의가 확인되지 않은 고객 정보를 활용하지 않습니다.`,
  },
  {
    ...
    id: 'GRP-008',
    name: '여신업무 어시스턴트',
    desc: '여신 상담·심사·약정 업무를 근거 데이터와 함께 지원한다',
    grounding: '여신 규정 인덱스 + 여신 계정계 MCP + 담보 평가 커넥터',
    ontology: true,
    tenant: '그룹 공통',
    admins: ['platform_admin', 'project_owner', 'agent_lead', 'agent_dev'],
    systemPrompt: `당신은 BNK금융그룹의 여신업무 어시스턴트입니다.

[역할]
- 여신 규정과 승인된 계정계·담보 평가 도구에 근거해 상담·심사 업무를 지원합니다.
- 근거를 찾지 못하면 확정하지 않고 필요한 확인 절차를 안내합니다.
...
export const DOC_ANSWERS: Record<string, DocAnswer[]> = {
  ...
  'GRP-002': [
    ...
    {
      q: '방금 올린 영업전략 초안의 핵심 3가지를 정리해줘.',
      a:
        '개인 문서 저장소의 「5월_영업전략_초안.docx」(PDOC-01 · 2026-06-01 적재 완료)를 기준으로 핵심은 ' +
        '① 중소기업 신규 상담을 산업단지 중심으로 확대 ② 기존 거래처의 만기·한도 갱신을 선제 관리 ③ ' +
        '상담 이력과 캠페인 반응을 주간 단위로 점검하는 세 가지입니다. 개인 문서 기반 요약이며 원문 확인 후 ' +
        '업무에 반영하십시오.',
    },
  ],
};
