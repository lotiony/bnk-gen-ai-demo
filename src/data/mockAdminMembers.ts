...
export const ADMIN_MEMBERS: AdminMember[] = [
  ...
  },
  {
    ...
    empNo: '20191115',
    name: '박서준',
    email: 'seojun.park@bnkfg.group.local',
    dept: '여신심사부',
    role: 'pm',
    status: 'active',
    projectCount: 2,
  ...
  },
  {
    ...
    empNo: '20200518',
    name: '최유나',
    email: 'yuna.choi@bnkfg.group.local',
    dept: '디지털채널부',
    role: 'pm',
    status: 'active',
    projectCount: 1,
  ...
  },
  {
    ...
    empNo: '20140402',
    name: '정성호',
    email: 'sungho.jung@bnkfg.group.local',
    dept: '정보보호부',
    role: 'reviewer',
    status: 'active',
    projectCount: 6,
  ...
  },
  {
    ...
    empNo: '20220115',
    name: '윤지원',
    email: 'jiwon.yoon@bnkfg.group.local',
    dept: '여신심사부',
    role: 'member',
    status: 'active',
    projectCount: 1,
  ...
  },
  {
    ...
    empNo: '20230420',
    name: '강은영',
    email: 'eunyoung.kang@bnkfg.group.local',
    dept: 'PB영업본부',
    role: 'member',
    status: 'invited',
    projectCount: 0,
