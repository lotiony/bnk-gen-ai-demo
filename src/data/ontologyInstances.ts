...
export const INSTANCES: Instance[] = [
  ...
  { id: 'app-0311', cls: '여신신청', label: 'APP-2026-0311', origin: 'DV_LOAN.V_LOAN_APPLICATION',
    props: { 신청번호: 'APP-2026-0311', 신청금액: '5.0억', 신청일자: '2026-08-14', 자금용도: '운전자금', 상환방식: '만기일시', 희망만기: '2027-08-13' } },
  ...
  { id: 'rv-0455', cls: '심사', label: 'RV-2026-0455', origin: 'DV_LOAN.V_CREDIT_REVIEW',
    props: { 심사번호: 'RV-2026-0455', 심사일자: '2026-08-20', 심사결과: '조건부승인(안)', 심사점수: '72.4', 조건부승인내용: '영업흑자 3개년 확인 조건' } },
